...
class PersonalModelEngineTest {
    @Test
    fun emptyModelIsExplicitlyEmpty() {
        ...
        assertNull(snapshot.nextSkillId)
        assertNull(snapshot.nextActionId)
    }

    @Test
    fun modelBecomesDevelopingAfterEvidenceSpansDaysAndDomains() {
        val evidence = listOf(
        ...
        assertEquals(11, snapshot.domainCount)
        assertEquals(11, snapshot.skillCount)
    }
